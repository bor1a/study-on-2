 ...
 */
final class Version20210827083134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, course_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1000) NOT NULL, number INT NOT NULL, PRIMARY KEY(id))');
